...
<script>
	$(document).ready(function(){
        ...
        var kecamatan_id      = {!! json_encode($kecamatan_id) !!};
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">	
                        <div class="form-group">	
                            ...
                            {!! Form::select('kecamatan_id',  $corekecamatan, $kecamatan_id, ['class' => 'selection-search-clear select-form', 'id' => 'kecamatan_id']) !!}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                <thead>
                    <tr>
                        ...
                        <th width="10%" style='text-align:center'>Kecamatan</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$position}}</td>
                        <td>{{$DashboardReview->getKecamatanName($service['kecamatan_id'])}}</td>
                        <td>{{$date}}</td>

            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row form-group">
                        <div class="col-md-6">
                            <div class="form-group">
                                <a class="text-dark">Upload Surat Permohonan Pencairan<a class='red'> *</a></a><br>
                                <input type="file" name="file_funds_application" id="file_funds_application" value="" accept=""/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <a class="text-dark">Upload Surat Perintah Pencairan<a class='red'> *</a></a><br>
                                <input type="file" name="file_funds_order" id="file_funds_order" value="" accept=""/>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">

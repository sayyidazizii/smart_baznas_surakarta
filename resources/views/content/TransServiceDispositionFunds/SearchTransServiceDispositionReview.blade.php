                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style='text-align:center'>
                            {{-- <a type="button" class="btn btn-outline-warning btn-sm" href="{{ url('/trans-service-disposition-funds/print-application/'.$disposition['service_disposition_id']) }}">Surat Permohonan</a> --}}

                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="number" name="service_requisition_nik" id="service_requisition_nik" value="" onChange="checkNIK(this.name, this.value);" autocomplete="off"/>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">	
                        <div class="form-group">	
                            ...
                            {!! Form::select('kecamatan_id',  $corekecamatan, 0, ['class' => 'selection-search-clear select-form', 'id' => 'kecamatan_id', 'name' => 'kecamatan_id']) !!}
                        </div>
                    </div>
                    <div class="col-md-6">	
                        <div class="form-group">	
                            <a class="text-dark">Kelurahan</a>
                            {!! Form::select('kelurahan_id',  $corekelurahan, 0, ['class' => 'selection-search-clear select-form', 'id' => 'kelurahan_id', 'name' => 'kelurahan_id']) !!}
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <a class="text-dark">Alamat Pemohon</a>
                            <textarea class="form-control input-bb" type="text" name="service_requisition_address" id="service_requisition_address" onChange="checkAddress(this.name, this.value);" autocomplete="off"></textarea>
                        </div>
                    </div>
                </div>

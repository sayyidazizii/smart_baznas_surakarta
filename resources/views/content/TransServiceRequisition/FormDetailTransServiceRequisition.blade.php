                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">	
                        <div class="form-group">	
                            ...
                            {!! Form::select('kecamatan_id',  $corekecamatan, $servicerequisition['kecamatan_id'], ['class' => 'selection-search-clear select-form', 'id' => 'kecamatan_id', 'name' => 'kecamatan_id', 'disabled' => true]) !!}
                        </div>
                    </div>
                    <div class="col-md-6">	
                        <div class="form-group">	
                            <a class="text-dark">Kelurahan</a>
                            {!! Form::select('kelurahan_id',  $corekelurahan, $servicerequisition['kelurahan_id'], ['class' => 'selection-search-clear select-form', 'id' => 'kelurahan_id', 'name' => 'kelurahan_id', 'disabled' => true]) !!}
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">

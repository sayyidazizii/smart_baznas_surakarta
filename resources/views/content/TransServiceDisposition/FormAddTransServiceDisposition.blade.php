                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="text" name="service_requisition_nik" id="service_requisition_nik" value="{{$servicerequisition['service_requisition_nik']}}" onChange="function_elements_add(this.name, this.value);" autocomplete="off" readonly/>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="text" name="kecamatan_name" id="kecamatan_name" value="{{$TransServiceDisposition->getKecamatanName($servicerequisition['kecamatan_id'])}}" onChange="function_elements_add(this.name, this.value);" autocomplete="off" readonly/>
                            <input class="form-control input-bb" type="hidden" name="kecamatan_id" id="kecamatan_id" value="{{$servicerequisition['kecamatan_id']}}" onChange="function_elements_add(this.name, this.value);" autocomplete="off" readonly/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <a class="text-dark">Kelurahan<a class='red'> *</a></a>
                            <input class="form-control input-bb" type="text" name="kelurahan_name" id="kelurahan_name" value="{{$TransServiceDisposition->getKelurahanName($servicerequisition['kelurahan_id'])}}" onChange="function_elements_add(this.name, this.value);" autocomplete="off" readonly/>
                            <input class="form-control input-bb" type="hidden" name="kelurahan_id" id="kelurahan_id" value="{{$servicerequisition['kelurahan_id']}}" onChange="function_elements_add(this.name, this.value);" autocomplete="off" readonly/>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <a class="text-dark">Alamat Pemohon</a>
                            <textarea class="form-control input-bb" type="text" name="service_requisition_address" id="service_requisition_address" autocomplete="off" readonly>{{$servicerequisition['service_requisition_address']}}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row form-group">

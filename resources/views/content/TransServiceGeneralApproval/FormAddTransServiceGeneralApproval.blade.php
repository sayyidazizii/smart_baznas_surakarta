...
<script>
    ...
    function changeFile(){
        var file = document.getElementById("file_sk").files;
        document.getElementById("file_disapprove").files = file;
        var file = document.getElementById("file_disapprove").files;
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Edit Pengajuan Surat Umum</li>
    </ol>
</nav>
...
<h3 class="page-title">
    Form Edit Pengajuan Surat Umum
</h3>
<br/>
@if(session('msg'))
    ...
    <div class="card border border-dark">
        <div class="card-header border-dark bg-dark">
            ...
            <div class="float-right">
                <button onclick="location.href='{{ url('trans-service-general-approval/search') }}'" name="Find" class="btn btn-sm btn-info" title="Back"><i class="fa fa-angle-left"></i>  Kembali</button>
            </div>
        </div>

    <form method="post" action="{{route('approve-service-general-approval')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row form-group">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control input-bb" type="hidden" name="service_general_token_approval" id="service_general_token_approval" value="{{$service_general_token_approval}}"/>
            ...
            <div class="row form-group" id="service-image">
                ...
                <div class="col-md-4">
                    <a class="text-dark">Upload Surat<a class='red'> *</a></a>
                    <br>
                    <br>
                    <input type="file" name="file_sk" id="file_sk" value="" accept="" onchange="changeFile()"/>
                </div>
            </div> 
            <div class="row form-group">
                <div class="col-md-12">
                    <div class="form-group">	
                        ...
                        <textarea class="form-control input-bb" name="service_general_remark" id="service_general_remark"></textarea>
                    </div>
                </div>
            </div>
            <br/>
        ...
        <div class="card-footer text-muted">
            <div class="form-actions float-right">
                <a name="Reset" class="btn btn-danger" href='#disapprove' data-toggle='modal'><i class="fa fa-times"></i> Disapprove</a>
                <button name="Save" class="btn btn-primary" href="{{ url('/trans-service-general-approval/approve') }}"><i class="fa fa-check"></i> Approve</button>
            </div>
        </div>
    </div>
</div>
...
<form method="post" action="{{route('disapprove-service-general-approval')}}" enctype="multipart/form-data">
    @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row form-group">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input hidden type="file" name="file_disapprove" id="file_disapprove" value="" accept=""/>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <a class="text-dark">Keterangan Disapprove <a class="red">*</a></a>
                                <textarea class="form-control input-bb" type="text" name="service_general_remark" id="service_general_remark" autocomplete="off"></textarea>
                                <input class="form-control input-bb" type="hidden" name="service_general_id" id="service_general_id" value="{{$service_general_id}}" onChange="function_elements_add(this.name, this.value);"/>
                            </div>
                        </div>
                    </div>
                </div>

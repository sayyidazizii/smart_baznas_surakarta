                ...
                <div class="row form-group">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="text" name="service_general_agency" id="service_general_agency" value="{{$servicegeneral['service_general_agency']}}" onChange="function_elements_add(this.name, this.value);" autocomplete="off"/>

                            <input class="form-control input-bb" type="hidden" name="service_general_token_edit" id="service_general_token_edit" value="{{$service_general_token_edit}}"/>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control input-bb" type="text" name="service_general_phone" id="service_general_phone" value="{{$servicegeneral['service_general_phone']}}" onChange="function_elements_add(this.name, this.value);" autocomplete="off"/>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <a class="text-dark">Prioritas<a class='red'> *</a></a>
                            {!! Form::select('service_general_priority',  $coreservicegeneralpriority, $servicegeneral['service_general_priority'], ['class' => 'selection-search-clear select-form', 'id' => 'service_general_priority']) !!}
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control input-bb" type="text" name="parameter_{{$parameter['service_general_parameter_id']}}" id="parameter_{{$parameter['service_general_parameter_id']}}"autocomplete="off">{{$parameter['service_general_parameter_value']}}</textarea>
                            </div>
                        </div>
                    </div>
                <?php }?>

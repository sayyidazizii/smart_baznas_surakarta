...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('trans-service-disposition') }}">Daftar Review Disposisi Bantuan</a></li>
                ...
                <div class="row form-group">
                    <div class="col-md-6">	
                        <div class="form-group">	
                            ...
                            <input class="form-control input-bb" type="text" name="section_id" id="section_id" value="{{$TransServiceDispositionReview->getSectionName($servicedisposition['section_id'])}}" onChange="function_elements_add(this.name, this.value);" readonly/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">	

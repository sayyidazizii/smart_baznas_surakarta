    ...
    <form method="post" action="{{route('approve-service-general-approval')}}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="row form-group" id="service-image">
                ...
                <div class="col-md-4">
                    <a class="text-dark">Upload Surat SK<a class='red'> *</a></a>
                    <br>
                    <br>
        ...
        <div class="card-footer text-muted">
            <div class="form-actions float-right">
                <a name="Reset" class="btn btn-danger" href="{{ url('/trans-service-general-approval/disapprove/'.$service_general_id) }}""><i class="fa fa-times"></i> Disapprove</a>

...
<script>
	$(document).ready(function(){
        ...
        if(service_requisition_no == null){
            $("#service_requisition_no").select2("val", "0");
        }
    });
    $(document).ready(function(){
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item active" aria-current="page">SMArT Baznas Surakarta</li>
    </ol>
</nav>
        ...
        <div class="row form-group">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input class="form-control input-bb" type="text" name="service_requisition_no" id="service_requisition_no" value="{{$service_requisition_no}}" autocomplete="off" placeholder="klik disini sebelum scan barcode" onClick="this.value='';"/>

...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Pembatalan Persetujuan Disposisi Bantuan</li>
    </ol>
</nav>
...
<h3 class="page-title">
    Form Pembatalan Persetujuan Disposisi Bantuan
</h3>
<br/>
@if(session('msg'))
    ...
    <div class="card border border-dark">
        <div class="card-header border-dark bg-dark">
            ...
            <div class="float-right">
                <button onclick="location.href='{{ url('trans-service-disposition-approval') }}'" name="Find" class="btn btn-sm btn-info" title="Back"><i class="fa fa-angle-left"></i>  Kembali</button>
            </div>
        </div>

        <form method="post" action="{{route('process-unapprove-service-disposition-approval')}}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <br/>
                <div class="row">
            ...
            <div class="card-footer text-muted">
                <div class="form-actions float-right">
                    <a class="btn btn-danger" href='#unapprove' data-toggle='modal'><i class="fa fa-times"></i> UnApprove</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control input-bb" type="text" name="unapprove_remark" id="unapprove_remark" autocomplete="off"></textarea>
                                <input class="form-control input-bb" type="hidden" name="service_disposition_id" id="service_disposition_id" value="{{$service_disposition_id}}" onChange="function_elements_add(this.name, this.value);"/>
                                <input class="form-control input-bb" type="hidden" name="service_disposition_approval_token_edit" id="service_disposition_approval_token_edit" value="{{$service_disposition_approval_token_edit}}"/>
                            </div>
                        </div>

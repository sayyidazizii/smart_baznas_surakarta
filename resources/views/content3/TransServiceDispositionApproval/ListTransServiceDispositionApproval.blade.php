            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php if($service['review_status']==1){?>
                        ...
                        <td class="">
                            ...
                            <?php if($service['approved_status']==1 && $service['review_status']==0){?>
                                <a type="button" class="btn btn-outline-danger btn-sm" href="{{ url('/trans-service-disposition-approval/unapprove/'.$service['service_disposition_id']) }}">UnApprove</a>
                            <?php } ?>
                        </td>
                    </tr>
                    <?php $no++; ?>

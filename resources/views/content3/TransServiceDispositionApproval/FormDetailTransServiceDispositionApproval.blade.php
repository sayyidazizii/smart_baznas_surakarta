...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('trans-service-disposition') }}">Daftar Persetujuan Disposisi Bantuan</a></li>
        <li class="breadcrumb-item active" aria-current="page">Detail Persetujuan Disposisi Bantuan</li>
    </ol>
</nav>
...
<h3 class="page-title">
    Form Detail Persetujuan Disposisi Bantuan
</h3>
<br/>
@if(session('msg'))
                ...
                <div class="row form-group">
                    <div class="col-md-6">	
                        <div class="form-group">	
                            ...
                            <input class="form-control input-bb" type="text" name="section_id" id="section_id" value="{{$TransServiceDispositionApproval->getSectionName($servicedisposition['section_id'])}}" onChange="function_elements_add(this.name, this.value);" readonly/>
                        </div>
                    </div>
                </div>
                <div class="row form-group">

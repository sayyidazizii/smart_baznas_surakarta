                ...
                <div class="row form-group">
                    <div class="col-md-6">	
                        <div class="form-group">	
                            ...
                            <input class="form-control input-bb" type="text" name="section_id" id="section_id" value="{{$TransServiceDisposition->getSectionName($servicedisposition['section_id'])}}" onChange="function_elements_add(this.name, this.value);" readonly/>
                        </div>
                    </div>
                </div>
                <div class="row form-group">

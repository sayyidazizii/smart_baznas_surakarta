...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <!-- Background Video-->
        <video class="bg-video" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop"><source src="{{ asset('resources/assets/mp4/baznassurakarta.mp4') }}" type="video/mp4" /></video>
        <!-- Masthead-->
        <div class="masthead">
            ...
            <div class="masthead-content text-white">
                <div class="container-fluid px-4 px-lg-0">
                    ...
                    {{-- <h1 class="fst-italic lh-1 mb-4">Siabas</h1>

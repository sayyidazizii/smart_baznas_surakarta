...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('trans-service-requisition') }}">Daftar Permintaan Layanan</a></li>
        <li class="breadcrumb-item"><a href="{{ url('trans-service-requisition/search') }}">Daftar Layanan</a></li>
        <li class="breadcrumb-item active" aria-current="page">Detail Permintaan Layanan</li>
    </ol>
</nav>
...
<h3 class="page-title">
    Form Detail Permintaan Layanan
</h3>
<br/>
@if(session('msg'))
                ...
                <div class="modal-body">
                    <div class="form-body form">
                        <div class="table-responsive" style="text-align : center;">
                            <img src="{{asset('storage/term/'.$servicerequisition['service_id'].'/'.$val['service_requisition_term_value'])}}">
                        </div>
                    </div>
                </div>
            </div>

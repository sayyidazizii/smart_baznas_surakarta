...
class TrackingController extends PublicController
{
    /**
    ...
    {
        $service_requisition_no = Session::get('service_requisition_no');

        $transservicerequisition = TransServiceRequisition::where('data_state', 0)
        ->where('service_requisition_no', $service_requisition_no)
        ->first();
        ...
        return view('content/Tracking/TrackingTransServiceRequisition',compact('transservicerequisition', 'service_requisition_no', 'servicerequisitionno', 'servicelog'));
    }    
    ...
    {
        Session::forget('service_requisition_no');
    ...
    {
        Session::put('service_requisition_no', $request->service_requisition_no);

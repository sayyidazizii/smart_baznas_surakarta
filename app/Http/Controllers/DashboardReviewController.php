...
class DashboardReviewController extends PublicController
{
    ...
    public function index()
    {
        ...
        // print_r($kecamatan_id);exit;

        $transservicerequisition = TransServiceRequisition::where('trans_service_requisition.data_state','=',0)
        ...
        if($section_id||$section_id!=null||$section_id!=''){
            $transservicerequisition   = $transservicerequisition->where('trans_service_disposition.section_id', $section_id);
        }
        if($service_id||$service_id!=null||$service_id!=''){
            $transservicerequisition   = $transservicerequisition->where('trans_service_requisition.service_id', $service_id);
        }
        if($kecamatan_id||$kecamatan_id!=null||$kecamatan_id!=''){
            $transservicerequisition   = $transservicerequisition->where('trans_service_disposition.kecamatan_id', $kecamatan_id);
        }
        ...
        return view('content/DashboardReview/ListTransServiceRequisition',compact('transservicerequisition', 'start_date', 'end_date', 'coresection', 'coreservice', 'corekecamatan', 'section_id', 'service_id', 'kecamatan_id'));
    }    
